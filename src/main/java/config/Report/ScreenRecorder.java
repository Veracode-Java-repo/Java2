...
public class ScreenRecorder implements Runnable {
    ...
    private ThreadLocal<ScreenRecorder> threadedRecorder = new ThreadLocal<>();
    ...
    public void setRecorder(ScreenRecorder videoRecorder) {
    ...
    public void startRecording( String videoName) {
        getRecorder().screenShotsPath = System.getProperty("user.dir") + "/Report-ScreenShot";
    ...
    private void convertJpgToMovie(String imgPath, String destPathOfVideo) {
        ...
        try (FFmpegFrameRecorder recorder = new FFmpegFrameRecorder(destPathOfVideo, (int) screenSize.getWidth(), (int) screenSize.getHeight())) {
			try {
